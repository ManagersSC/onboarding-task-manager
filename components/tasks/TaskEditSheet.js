      ...
      >
        <SheetContent className="sm:max-w-md overflow-y-auto">
          <SheetHeader className="pb-4 border-b">
            <SheetTitle className="text-xl">{loading ? <Skeleton className="h-8 w-3/4" /> : "Task Details"}</SheetTitle>
            <SheetDescription>
                            ...
                            <FormControl>
                              <Textarea
                                ...
                                className={cn(
                                  ...
                                  isFieldModified("description") && "border-amber-500 bg-amber-50 dark:bg-amber-950/20",
                                )}
                                {...field}
                              />
                            </FormControl>
                            ...
                            <div className="space-y-1">
                              <Select onValueChange={field.onChange} value={field.value || ""}>
                                <FormControl>
                                  <SelectTrigger
                                    className={cn(
                                      isFieldModified("week") && "border-amber-500 bg-amber-50 dark:bg-amber-950/20",
                                    )}
                                  >
                          ...
                          <div className="space-y-1">
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                className={cn(
                                  isFieldModified("location") && "border-amber-500 bg-amber-50 dark:bg-amber-950/20",
                                )}
                              />
                            </FormControl>
                          ...
                          <div className="space-y-1">
                            <FormControl>
                              <Input
                                ...
                                className={cn(
                                  isFieldModified("resourceUrl") && "border-amber-500 bg-amber-50 dark:bg-amber-950/20",
                                )}
                              />
                            </FormControl>
                            {isFieldModified("resourceUrl") && (
                          ...
                          <div className="space-y-2">
                            <div
                              className={cn(
                                ...
                                isFieldModified("attachments") && "border-amber-500 bg-amber-50 dark:bg-amber-950/20",
                              )}
                ...
                <div className="pt-4 border-t mt-6">
                  ...
                  <SheetFooter className="flex justify-between sm:justify-between">
                    <div className="flex gap-2">
                      ...
                      {formModified && (
                        <Button type="button" variant="ghost" onClick={resetForm} disabled={loading || !formModified}>
                          Reset
                        </Button>
                      )}
                    </div>
